...
// draw
$f3->route('GET /draw','Draw->DefaultDisplay');
$f3->route('POST /draw/random/name','Draw->RandomName');
$f3->route('POST /draw/resetdrawnflag','Draw->ResetDrawnFlag');
$f3->route('POST /draw/vendordrawing','Draw->VendorDrawing');
