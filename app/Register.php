...
class Register {
  ...
  function ProcessPOST($f3) {
    ...
    $result = $f3->get('db')->exec(
      'INSERT INTO guests ("lastname","firstname","company","company_type","email","pre_registration","timestamp","drawing","drawn","vendordrawing")
        VALUES (:lastname,:firstname,:company,:company_type,:email,:pre_registration,:timestamp,:drawing,:drawn,:vendordrawing)',
	...
	':drawing'=>$f3->get('POST.drawing'),
	':drawn'=>'0',
	':vendordrawing'=>$f3->get('POST.vendordrawing')
      )
    );
